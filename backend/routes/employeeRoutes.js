...
const { getAllEmployees,changePassword,addEmployee, getAllDepartments, getAllRoles, getAllSupervisors, jobSeekerSignUp } = require('../controllers/employeeController');
