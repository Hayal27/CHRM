...
import EnterpriseDataModule from '../components/education-office/EnterpriseDataModule';
...
const EnterpriseDataPage: React.FC = () => {
    ...
    return (
      <div style={{ padding: '24px', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: 16 }}>
          <Title level={3}>Loading Enterprise Data Management</Title>
          ...
          description={
            <div>
              ...
              <ul>
                ...
                <li>Run the enterprise college support setup script</li>
              </ul>
            </div>
          }
          type="error"
  ...
  return (
    <div style={{ padding: '24px' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p>
          Complete management system for enterprise data with college associations and comprehensive reporting
          {colleges.length > 0 && (
        ...
        {colleges.length === 0 && (
          <Alert
            ...
            description="No colleges are available in the database. Please add colleges first before managing enterprise data."
            type="warning"
            showIcon
      ...
      <EnterpriseDataModule colleges={colleges} />
    </div>
  );
};
