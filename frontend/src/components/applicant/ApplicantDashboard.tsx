...
const ApplicantDashboard: React.FC = () => {
  ...
  const fetchVacancies = async () => {
    try {
      ...
      const response = await axios.get('https://hrbackend.wingtechai.com/api/vacancies', {
        params,
  ...
  const fetchApplications = async () => {
    try {
      ...
      const response = await axios.get('https://hrbackend.wingtechai.com/api/applications', {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const submitApplication = async (values: any) => {
    ...
    try {
      ...
      const response = await axios.post('https://hrbackend.wingtechai.com/api/applications', applicationData, {
        headers: { Authorization: `Bearer ${token}` }
      });
      ...
      if (values.cv_file && application_id) {
        ...
        await axios.post(`https://hrbackend.wingtechai.com/api/applications/${application_id}/cv`, formData, {
          headers: {
