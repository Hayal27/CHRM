...
const LoginPage: React.FC = () => {
    ...
    const handleForgotRequest = async (e: React.FormEvent) => {
        ...
        try {
            const res = await axios.post('https://hrbackend.wingtechai.com/api/requestPasswordReset', { user_name: forgotEmail });
            if (res.data.success) {
    ...
    const handleForgotReset = async (e: React.FormEvent) => {
        ...
        setForgotLoading(true);
        try {
            const res = await axios.post('https://hrbackend.wingtechai.com/api/reset-resetPassword', {
